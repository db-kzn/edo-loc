...
using EDO_FOMS.Application.Features.DocumentTypes.Commands.Delete;
using EDO_FOMS.Application.Features.DocumentTypes.Queries.Export;
...
namespace EDO_FOMS.Server.Controllers.Docums
{
    ...
    public class DocumentTypesController : BaseApiController<DocumentTypesController>
    {
        ...
        /// <returns></returns>
        [Authorize(Policy = Permissions.Documents.Export)]
        [HttpGet("export")]
