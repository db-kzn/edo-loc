...
namespace EDO_FOMS.Application.Features.ExtendedAttributes.Commands.Delete
{
            ...
            where TId : IEquatable<TId>
    {
        ...
        public async Task<Result<TId>> Handle(DeleteExtendedAttributeCommand<TId, TEntityId, TEntity, TExtendedAttribute> command, CancellationToken cancellationToken)
        {
            ...
            if (extendedAttribute != null)
            {
                ...
                cacheKeys.Add(AppConstants.Cache.GetAllEntityExtendedAttributesCacheKey(typeof(TEntity).Name));
