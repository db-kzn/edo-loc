...
namespace EDO_FOMS.Application.Responses.Docums
{
    ...
    {
        public List<DocCardAgreementResponse> Agreements { get; set; } = new();
    ...
    public class DocCardAgreementResponse
    {
        ...
        public DocCardAgreementResponse() { }
        public DocCardAgreementResponse(Agreement a)
        {
