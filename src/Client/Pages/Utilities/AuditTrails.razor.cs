...
namespace EDO_FOMS.Client.Pages.Utilities
{
    public partial class AuditTrails
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _canExportAuditTrails = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Export)).Succeeded;
            _canSearchAuditTrails = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Search)).Succeeded;
