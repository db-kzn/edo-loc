...
namespace EDO_FOMS.Client.Pages.Identity
{
    public partial class Users
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _canCreateUsers = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Create)).Succeeded;
            _canSearchUsers = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Search)).Succeeded;
            _canExportUsers = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Export)).Succeeded;
            _canViewRoles = (await _authService.AuthorizeAsync(_currentUser, Permissions.Roles.View)).Succeeded;
        ...
        private bool Search(UserResponse user)
        {
            ...
            if (user.GivenName?.Contains(_searchString, StringComparison.OrdinalIgnoreCase) == true)
            {
                return true;
            }
