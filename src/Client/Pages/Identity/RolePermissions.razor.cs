...
namespace EDO_FOMS.Client.Pages.Identity
{
    public partial class RolePermissions
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _canEditRolePermissions = (await _authService.AuthorizeAsync(_currentUser, Permissions.RoleClaims.Edit)).Succeeded;
            _canSearchRolePermissions = (await _authService.AuthorizeAsync(_currentUser, Permissions.RoleClaims.View)).Succeeded;
        ...
        private async Task SaveAsync()
        {
            ...
            if (result.Succeeded)
            {
                ...
                await HubConnection.SendAsync(AppConstants.SignalR.SendRegenerateTokens);
                await HubConnection.SendAsync(AppConstants.SignalR.OnChangeRolePermissions, _currentUser.GetUserId(), request.RoleId);
                _navigationManager.NavigateTo("/identity/roles");
            }
            else
            {
