...
namespace EDO_FOMS.Client.Pages.Identity
{
    public partial class UserRoles
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _canEditUsers = (await _authService.AuthorizeAsync(_currentUser, Permissions.System.Edit)).Succeeded;
            ...
            if (result.Succeeded)
            {
                ...
                if (user != null)
                {
                    ...
                    Description = string.Format(_localizer["Manage {0} {1}'s Roles"], user.GivenName, user.Surname);
