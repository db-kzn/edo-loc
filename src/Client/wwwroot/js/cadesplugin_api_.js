; (function () {
    ...
    function load_extension() {
        ...
        fileref.setAttribute("src", //"js/nmcades_plugin_api.js");
            (isOpera || isYandex)
    ...
    function IsNativeMessageSupported() {
        ...
        if (browserSpecs.name === 'Edg') { return true; } // 15
        if (browserSpecs.name === 'YaBrowser') { isYandex = true; return true; }
        if (browserSpecs.name === 'Chrome') { return (browserSpecs.version >= 45); } // 29
        if (browserSpecs.name === 'Opera') { isOpera = true; return (browserSpecs.version >= 33); } // 16
        if (browserSpecs.name === 'Firefox') { isFireFox = true; return (browserSpecs.version >= 52); } // 50
        if (browserSpecs.name === 'Safari') { isSafari = true; return (browserSpecs.version >= 12); } // 14
