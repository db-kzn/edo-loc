...
{
    public abstract class AuditableContext : IdentityDbContext<EdoFomsUser, EdoFomsRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, EdoFomsRoleClaim, IdentityUserToken<string>>
    {
