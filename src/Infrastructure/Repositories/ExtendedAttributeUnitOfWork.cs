...
namespace EDO_FOMS.Infrastructure.Repositories
{
    public class ExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> : IExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> where TEntity : AuditableEntity<TEntityId>
    {
        ...
        private readonly EdoFomsContext _dbContext;
        private bool _disposed;
        private Hashtable _repositories;
        private readonly IAppCache _cache;

        public ExtendedAttributeUnitOfWork(EdoFomsContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
